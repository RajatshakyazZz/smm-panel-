            ...
            <div className="mt-8 border-t border-slate-800/80 pt-6">
              ...
              <div className="flex flex-wrap items-center gap-3">
                <button
                  ...
                  className="inline-flex items-center gap-2 rounded-xl bg-blue-600/90 px-4 py-2 text-xs font-semibold text-white shadow-lg shadow-blue-600/20 transition-all hover:bg-blue-500"
                >
                ...
                <button
                  ...
                  className="inline-flex items-center gap-2 rounded-xl border border-purple-500/30 bg-purple-500/10 px-4 py-2 text-xs font-semibold text-purple-300 transition-all hover:bg-purple-500/20"
                >
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder="e.g. rajat_creator or admin"
